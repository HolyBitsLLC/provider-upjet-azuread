...
func (in *MemberInitParameters) DeepCopyInto(out *MemberInitParameters) {
	*out = *in
	if in.GroupMemberObjectID != nil {
		in, out := &in.GroupMemberObjectID, &out.GroupMemberObjectID
		*out = new(string)
		**out = **in
	}
	if in.GroupMemberObjectIDRef != nil {
		in, out := &in.GroupMemberObjectIDRef, &out.GroupMemberObjectIDRef
		*out = new(v1.Reference)
		(*in).DeepCopyInto(*out)
	}
	if in.GroupMemberObjectIDSelector != nil {
		in, out := &in.GroupMemberObjectIDSelector, &out.GroupMemberObjectIDSelector
		*out = new(v1.Selector)
		(*in).DeepCopyInto(*out)
	}
